<?php
    ...
    require_once("./session_cart/cart_session.php");
?>
    <!-- Topbar Start -->
    <?php
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="text-center py-4 overflow-hidden">
                                <a class="h6 text-decoration-none text-truncate" href="./detail.php?id=<?php echo $row['id']; ?>"><?php echo $row['product_name']; ?></a>
